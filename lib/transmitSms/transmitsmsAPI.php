...
//TODO: incorporate into native Moodle
//TODO: use key/secret injection
class transmitsmsAPI
{
    ...
    {
        if ($key) $this->transmitKey = $key;
        if ($secret) $this->transmitSecret = $secret;

        $this->authHeader = array('Authorization: Basic ' . base64_encode($this->transmitKey . ':' . $this->transmitSecret));
    }
